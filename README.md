...
This repository contains the source code for the sample application from the talk "Easy decoupled sitebuilding with <a href="https://graphql.org">GraphQL</a> and <a href="github.com/zeit/next.js/">Next.js</a>" held in October 2017 at Drupalcon Vienna and Helsinki.js Meetup.
